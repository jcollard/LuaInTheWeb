        ...
        setup(build) {
          ...
          build.onLoad({ filter: /.*/, namespace: 'lua-runtime-shim' }, () => ({
            ...
            contents: `
              ...
              export { audioLuaCode } from '${join(LUA_RUNTIME_SRC, 'audioLuaCode/audio.ts').replace(/\\/g, '/')}';
              export { chipLuaCode } from '${join(LUA_RUNTIME_SRC, 'chipLuaCode/chip.ts').replace(/\\/g, '/')}';
            `,
            loader: 'ts',
