...
const XTERM_DIR = join(ROOT_NODE_MODULES, 'xterm');
 ...
 *
 * This allows HTML shell/ANSI exports to work fully offline without CDN dependencies.
 * Run "npm run build:xterm" to regenerate this file.
 *
 * Note: CanvasAddon is bundled separately in packages/export via bundle-xterm-canvas.js
 * because it requires shared module context with xterm.js (single IIFE bundle).
 */
