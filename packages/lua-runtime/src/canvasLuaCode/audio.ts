 ...
 * These functions are also available via require('ail_audio') when the standalone
 * audio module is loaded. The canvas.* versions are kept for backward compatibility.
 */
