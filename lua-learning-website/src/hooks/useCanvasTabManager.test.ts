...
describe('useCanvasTabManager', () => {
  ...
  describe('hasCanvasTabs', () => {
    ...
    it('should return false when only file tabs exist', () => {
      const tabs: TabInfo[] = [
        { path: '/file1.lua', name: 'file1.lua', isDirty: false, type: 'file', isPreview: false, isPinned: false },
        { path: '/file2.lua', name: 'file2.lua', isDirty: false, type: 'file', isPreview: false, isPinned: false },
      ]
    ...
    it('should return true when canvas tabs exist', () => {
      const tabs: TabInfo[] = [
        { path: '/file1.lua', name: 'file1.lua', isDirty: false, type: 'file', isPreview: false, isPinned: false },
        { path: 'canvas://canvas-123', name: 'Canvas', isDirty: false, type: 'canvas', isPreview: false, isPinned: false },
      ]
  ...
  describe('canvasCode', () => {
    ...
    it('should return code for active canvas tab after running', () => {
      ...
      const tabs: TabInfo[] = [
        { path: canvasTabPath, name: 'Canvas', isDirty: false, type: 'canvas', isPreview: false, isPinned: false },
      ]
    ...
    it('should preserve canvas code when switching to file tab', () => {
      ...
      const canvasTab: TabInfo = { path: canvasTabPath, name: 'Canvas', isDirty: false, type: 'canvas', isPreview: false, isPinned: false }
      const fileTab: TabInfo = { path: '/file.lua', name: 'file.lua', isDirty: false, type: 'file', isPreview: false, isPinned: false }
